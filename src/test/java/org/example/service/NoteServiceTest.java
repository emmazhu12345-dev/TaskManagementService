...
class NoteServiceTest {
    ...
    void listMyNotes_shouldReturnNotesForOwner() {
        ...
        // Act
        Page<Note> result = noteService.listMyNotes("emma", pageable);

        // Assert
        assertThat(result.getContent()).hasSize(2);
        assertThat(result.getTotalElements()).isEqualTo(5);
        verify(userRepository).findByUsername("emma");
    ...
    void create_shouldPersistNoteWithOwner() {
        ...
        // Act
        Note saved = noteService.create("emma", "Trip", "Pack checklist");
    ...
    void getOne_shouldReturnOwnedNote() {
        ...
        // Act
        Note result = noteService.getOne("emma", 99L);
    ...
    void getOne_shouldThrowWhenNoteMissing() {
        ...
        assertThatThrownBy(() -> noteService.getOne("emma", 123L))
                .isInstanceOf(ResponseStatusException.class)
                .extracting(ex -> ((ResponseStatusException) ex).getStatusCode())
                .isEqualTo(HttpStatus.NOT_FOUND);
    }
    ...
    void update_shouldModifyFieldsAndSave() {
        ...
        // Act
        Note updated = noteService.update("emma", 7L, "New", "NewC");
    ...
    void update_shouldThrowWhenNoteMissing() {
        ...
        assertThatThrownBy(() -> noteService.update("emma", 7L, "t", "c"))
                .isInstanceOf(ResponseStatusException.class)
                .extracting(ex -> ((ResponseStatusException) ex).getStatusCode())
                .isEqualTo(HttpStatus.NOT_FOUND);
    ...
    void delete_shouldThrowWhenNoteMissing() {
        ...
        assertThatThrownBy(() -> noteService.delete("emma", 5L))
                .isInstanceOf(ResponseStatusException.class)
                .extracting(ex -> ((ResponseStatusException) ex).getStatusCode())
                .isEqualTo(HttpStatus.NOT_FOUND);
